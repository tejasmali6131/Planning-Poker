...
describe('CreateRoom Component', () => {
  ...
  describe('Form Elements and UI', () => {
    ...
    test('should display both deck types with cards preview', () => {
      ...
      expect(screen.getByText('65')).toBeInTheDocument(); // Unique to Fibonacci
      ...
      expect(screen.getByText('40')).toBeInTheDocument(); // Unique to Modified Fibonacci
    });
  ...
  describe('Room Creation', () => {
    ...
    test('should store correct room configuration in localStorage', async () => {
      ...
      expect(roomData.cards).toEqual(["0", "½", "1", "2", "3", "5", "8", "13", "20", "40", "?"]);
